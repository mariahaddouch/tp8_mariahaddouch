...
public class CompteController {
    ...
    // 🟢 READ : Récupérer tous les comptes (support JSON + XML)
    @GetMapping(value = "/comptes", produces = { "application/json", "application/xml" })
    public List<Compte> getAllComptes() {
        return compteRepository.findAll();
    }

    // 🟢 READ : Récupérer un compte par ID (support JSON + XML)
    ...
    // 🟡 CREATE : Ajouter un nouveau compte (support JSON + XML)
    @PostMapping(
            value = "/comptes",
    ...
    // 🟠 UPDATE : Modifier un compte (support JSON + XML)
    @PutMapping(
            value = "/comptes/{id}",
            consumes = { "application/json", "application/xml" },
            produces = { "application/json", "application/xml" }
